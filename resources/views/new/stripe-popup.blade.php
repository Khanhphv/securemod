    ...
    <div id="stripe-popup" class="modal bottom-sheet">
            ...
            <form action="/stripe-payment" method="get">
                ...
                <div class="row">
                    <div class="input-field col s12 m6">
                        <input placeholder="Placeholder" id="autocomplete-input" type="text" class="autocomplete validate">
        ...
        window.onload = function () {
            (async () => {
                const response = await fetch(
                    'https://parseapi.back4app.com/classes/Continentscountriescities_Country?limit=1000&excludeKeys=emoji,phone,currency,shape',
                    {
                        headers: {
                            'X-Parse-Application-Id': 'V953yi6b8Ie9xUt8FgmhBm5Ho0dlHDOQnHLfxv3B', // This is your app's application id
                            'X-Parse-REST-API-Key': 'Qyme9vJU33EKhss2Ph1zdKe6ZdeG2AMkUs9kBcLl', // This is your app's REST API key
                        }
                    }
                );
